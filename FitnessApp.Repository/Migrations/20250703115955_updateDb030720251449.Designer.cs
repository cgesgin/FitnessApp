...
namespace FitnessApp.Repository.Migrations
{
    ...
    [Migration("20250703115955_updateDb030720251449")]
    partial class updateDb030720251449
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitnessApp.Core.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("FitnessApp.Core.Models.Member", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FitnessApp.Core.Models.MembershipPlan", b =>
                {
                    b.HasOne("FitnessApp.Core.Models.MembershipType", "MembershipType")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FitnessApp.Core.Models.AppUser", null)
                        .WithMany()
